...
import static com.stc.report.XMLReporter.getXMLReporter;
	...
	private static void createOverviewHTML(){
		try{
			...
			while(i.hasNext()){
				...
				float passCnt=new Float(suitePassCnt.getTextContent());
				float failCnt=new Float(suiteFailCnt.getTextContent());
				float skipCnt=new Float(suiteSkipCnt.getTextContent());
				...
				suiteMap.put("suiteName", name.getTextContent());
				suiteMap.put("suitePassCnt", suitePassCnt.getTextContent());
				suiteMap.put("suiteSkipCnt", suiteSkipCnt.getTextContent());
				suiteMap.put("suiteFailCnt", suiteFailCnt.getTextContent());
				//suiteMap.put("suiteTotalCnt", suiteTotalCnt.getTextContent());
				...
				for (int n = 0; n < testList.getLength(); n++) {
					...
					passCnt=new Integer(testPassCnt.getTextContent());
					failCnt=new Integer(testFailCnt.getTextContent());
					skipCnt=new Integer(testSkipCnt.getTextContent());
					...
					xmlTestMap.put("testName", testName.getTextContent());
					xmlTestMap.put("testPassCnt", testPassCnt.getTextContent());
					xmlTestMap.put("testSkipCnt", testSkipCnt.getTextContent());
					xmlTestMap.put("testFailCnt", testFailCnt.getTextContent());
				...
				while(j.hasNext()){
					...
					float scenarioCnt=new Float(scenarioTotalCnt.getTextContent());
					failCnt=new Float(scenarioFailCnt.getTextContent());
					...
					xmlFeatureMap.put("featureName", name.getTextContent());
					...
					xmlFeatureMap.put("scenarioFailCnt", scenarioFailCnt.getTextContent());
		...
		try{
			...
			while(i.hasNext()){
				...
				for (int n = 0; n < testList.getLength(); n++) {	
					...
					xmlTestMap.put("testStatus", status.getTextContent());
					xmlTestMap.put("testName", name.getTextContent());
					...
					for (int j = 0; j < testcaseList.getLength(); j++) {
						...
						testcaseMap.put("testcaseStatus", status.getTextContent());
						testcaseMap.put("testcaseName", name.getTextContent());
				...
				while(i.hasNext()){
					...
					for (int n = 0; n < featureList.getLength(); n++) {
						...
						xmlFeatureMap.put("status", status.getTextContent());
						xmlFeatureMap.put("featureName", name.getTextContent());
						...
						for (int j = 0; j < testScenarioList.getLength(); j++) {
							...
							testScenarioMap.put("scenarioStatus", status.getTextContent());
							testScenarioMap.put("testScenarioName", name.getTextContent());
		...
		try{
			...
			while(i.hasNext()){
				...
				for (int n = 0; n < xmlTestList.getLength(); n++) {
					...
					xmlTestMap.put("testName", name.getTextContent());
					String xmlTestName = name.getTextContent();
					//Create data-model
					List<Object> testCases=new ArrayList<Object>();
					...
					for (int j = 0; j < testcaseList.getLength(); j++) {
						...
						testcaseMap.put("testcaseStatus", status.getTextContent());
						testcaseMap.put("testcaseName", name.getTextContent());
						testcaseMap.put("testcaseDuration", duration.getTextContent());
						...
						for (int k = 0; k < teststepList.getLength(); k++) {
							...
							teststepMap.put("stepName", step.getTextContent());
							if(error.getTextContent().length()>15){
								teststepMap.put("stepError", error.getTextContent().substring(0,14));
							}
							else{
								teststepMap.put("stepError", error.getTextContent());
							}
							String fullError="Error Msg: "+error.getTextContent();
							fullError=fullError+" Stacktrace: "+trace.getTextContent();
							...
							teststepMap.put("stepScreenshot", screenshot.getTextContent());
							teststepMap.put("stepStatus", status.getTextContent());
	...
	public static void createFeatureHTML(){
		try{
			...
			while(i.hasNext()){
				...
				xmlFeatureMap.put("featureName", name.getTextContent());
				String xmlFeatureName = name.getTextContent();
			    ...
			    for (int j = 0; j < xmlScenarioList.getLength(); j++) {
					...
					testScenarioMap.put("scenarioStatus", status.getTextContent());
					testScenarioMap.put("scenarioName", name.getTextContent());
					...
					for (int k = 0; k < xmlStepDefinitionList.getLength(); k++) {
						...
						stepDefinitionMap.put("stepName", name.getTextContent());
						stepDefinition=stepDefinition+name.getTextContent()+"<br>";
						stepDefinitionMap.put("stepDefinitionStatus",stepDefinitionStatus.getTextContent());
						...
						for(int l = 0; l < xmlExecutionStepList.getLength(); l++){
							...
							executionStepMap.put("step", step.getTextContent());
							if(error.getTextContent().length()>15){
								executionStepMap.put("stepError", error.getTextContent().substring(0,14));
							}
							else{
								executionStepMap.put("stepError", error.getTextContent());
							}
							String fullError="Error Msg: "+error.getTextContent();
							fullError=fullError+" Stacktrace: "+trace.getTextContent();
							...
							executionStepMap.put("stepScreenshot", screenshot.getTextContent());
							executionStepMap.put("status", status.getTextContent());
